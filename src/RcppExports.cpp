...
Rcpp::DataFrame create_read_type_cpp(const std::string& input_sam_path, const Rcpp::List block_ann, const Rcpp::List gene_range);
RcppExport SEXP SGNB_create_read_type_cpp(SEXP input_sam_pathSEXP, SEXP block_annSEXP, SEXP gene_rangeSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(create_read_type_cpp(input_sam_path, block_ann, gene_range));
    return rcpp_result_gen;
END_RCPP
}
// create_read_type_group_cpp
Rcpp::DataFrame create_read_type_group_cpp(const std::vector<std::string>& read_gene_unique_vec, const std::vector<std::string>& read_gene_vec, const std::vector<std::string>& read_type_vec);
RcppExport SEXP SGNB_create_read_type_group_cpp(SEXP read_gene_unique_vecSEXP, SEXP read_gene_vecSEXP, SEXP read_type_vecSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(create_read_type_group_cpp(read_gene_unique_vec, read_gene_vec, read_type_vec));
    return rcpp_result_gen;
END_RCPP
}
// fit_SGNB_cpp
